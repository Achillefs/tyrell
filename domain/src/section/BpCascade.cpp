...
BpCascade::BpCascade(float f0_1, float q1, float f0_2, float q2, int sample_rate, float gain)
    : stage1_{make_stage(f0_1, q1, sample_rate)}, stage2_{make_stage(f0_2, q2, sample_rate)},
      gain_{gain} {
}
